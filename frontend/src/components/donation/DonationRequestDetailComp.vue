        ...
        <body data-spy="scroll" data-target=".navbar" data-offset="50">
          ...
          <div id="section3" class="container-fluid" style="padding-top:70px;padding-bottom:70px">
              ...
              <v-list-item-content>
                ...
                <v-row>
                  ...
                  <v-col cols="1" class="d-flex justify-content-center">
                    ...
                    <v-btn icon color="pink" v-if="uid == msg.userId" @click="clickDelete(msg.cheerupid)">
            ...
            <v-dialog v-model="deleteFlag" max-width="290">
              <v-card>
                <v-card-title class="headline"
                  ><h5><small>메세지를 삭제하시겠습니까?</small></h5></v-card-title
                >
                <v-card-actions>
                  <v-spacer></v-spacer>
                  <v-btn color="red darken-1" text @click="deleteMsg(deleteIndex)">
                    Yes
                  </v-btn>
                  <v-btn color="blue darken-1" text @click="deleteFlag = false">
                    No
                  </v-btn>
                </v-card-actions>
              </v-card>
            ...
            <v-dialog v-model="modifyFlag" max-width="450">
              <v-card>
                <v-card-title class="headline"
                  ><h5><small>메세지 수정</small></h5></v-card-title
                >
                <v-card-text>
                ...
                <v-card-actions>
                  <v-spacer></v-spacer>
                  <v-btn color="blue darken-1" text @click="modifyMsg(tempMsg)">
                    수정
                  </v-btn>
                  <v-btn color="red darken-1" text @click="modifyFlag=false, tempMsg.msg=temp">
                    취소
                  </v-btn>
                </v-card-actions>
              </v-card>
